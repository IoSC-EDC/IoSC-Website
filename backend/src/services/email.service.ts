...
export class EmailService {
   ...
   */
  private static getTeamEmailContent(userName: string, interests?: string[]): { subject: string; bodyHtml: string } {
   ...
   */
  private static renderBrandedEmailHtml(userName: string, interests?: string[]): { subject: string; htmlContent: string } {
